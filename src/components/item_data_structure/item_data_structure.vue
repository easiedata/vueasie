...
<script>
  ...
  export default {
    ...
    methods:{
      emit_new_structure(){
        this.$emit('new_data_structure', this.group_list);
    ...
    watch:{
      ...
      initial_data(){
        this.$emit('new_initial_data', this.initial_data)
      },
      group_options(){
