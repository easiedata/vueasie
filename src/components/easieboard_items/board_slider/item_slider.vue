<template>
  <div @click="on_input" class="e-px-4 e-w-100" style="height:40px; margin-top:40px;">
  ...
  export default {
    ...
    data(){
      return {
        options: {
          ...
          height: 4,
          contained: false,
          direction: this.item_meta.direction,
    ...
    methods:{
      on_input(){
        ...
        this.$emit('new_filter', {rule: rule, item_meta: new_item_meta});
